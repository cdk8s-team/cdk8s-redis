...
| <code><a href="#cdk8s-redis.Redis.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="cdk8s-redis.Redis.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="cdk8s-redis.Redis.with.parameter.mixins"></a>
